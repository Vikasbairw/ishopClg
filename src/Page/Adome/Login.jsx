...
function Login() {
  ...
  const { setadmin, admin ,notify} = useContext(Context);
  ...
  function UserHandler(e) {
    ...
    axios.post("http://localhost:5000/admin/login_admin", { email, password })
      .then((response) => {
        if (response.data.status === 1) {
          setadmin(response.data); // Assuming this sets admin data in your context
          if (admin === null) {
            navigate('/admin');
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={UserHandler}>
              <div>
                <label
                  htmlFor="email"
